...
def get_url(base_url):
    ...
    # else: 					#获取基于关键词的url模板
    # base_url=base_url+'search?q='+keyword+'&ratios=portrait'+'&sorting=random'+'&page='
    base_url=base_url+'search'
    return base_url         #返回模板


def get_img_url(base_url):
    params={'categories':'010','purity':'100','ratios':'portrait','topRange':'1w','sorting':'toplist','order':'desc','page':0}#参数字典
